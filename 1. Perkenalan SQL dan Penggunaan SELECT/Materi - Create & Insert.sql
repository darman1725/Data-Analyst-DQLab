...
/* Menggunakan database dqlabmartbasicl */
USE dqlabmartbasic;

/* Memastikan tabel ms_pelanggan_dqlab sudah kosong */
DROP TABLE IF EXISTS `ms_pelanggan_dqlab`;

-- Membuat tabel dengan nama ms_pelanggan_dqlab
...
-- Menggunakan perintah LOCK
LOCK TABLES `ms_pelanggan_dqlab` WRITE;

-- Melakukan input data pada tabel ms_pelanggan_dqlab
...
-- Menjalankan perintah UNLOCK
UNLOCK TABLES;

/* Memastikan tabel ms_produk_dqlab sudah kosong */
DROP TABLE IF EXISTS `ms_produk_dqlab`;

-- Membuat tabel dengan nama ms_produk_dqlab
...
-- Melakukan input data pada tabel ms_produk_dqlab
...
/* Memastikan tabel tr_penjualan_dqlab sudah kosong */
DROP TABLE IF EXISTS `tr_penjualan_dqlab`;

-- Membuat tabel dengan nama tr_penjualan_dqlab
...
-- Melakukan input data pada tabel tr_penjualan_dqlab
